...
from pyjl.transpiler import JuliaDecoratorRewriter, JuliaTranspiler, JuliaMethodCallRewriter, JuliaYieldRewriter, julia_decorator_rewriter
...
def julia_settings(args, env=os.environ):
    ...
    return LanguageSettings(
        ...
        post_rewriters=[JuliaMethodCallRewriter(), JuliaYieldRewriter()],
