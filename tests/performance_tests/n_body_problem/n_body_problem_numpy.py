...
SYSTEM = np.array(
    [
        ...
        [
            4.84143144246472090e00,  # jupiter
        ...
        [
            1.53796971148509165e01,  # neptune
...
def advance(dt, n, bodies=SYSTEM, pairs=PAIRS):
    for i in range(n):
        for j in range(len(pairs)):
            ((x1, y1, z1, v11, v12, v13, m1), (x2, y2, z2, v21, v22, v23, m2)) = pairs[
                j
            ]
            dx = x1 - x2
            dy = y1 - y2
