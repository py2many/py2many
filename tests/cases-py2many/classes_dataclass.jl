...
mutable struct Register <: AbstractRegister
                ...
                function __init__(self::AbstractRegister, )
                    setfield!(self::AbstractRegister, :, )
                end
            

                function __repr__(self::AbstractRegister)::String 
                    return AbstractRegister(self.) 
                end
...
mutable struct ValueHolder <: AbstractValueHolder
                ...
                function __init__(self::AbstractValueHolder, )
                    setfield!(self::AbstractValueHolder, :, )
                end
            

                function __repr__(self::AbstractValueHolder)::String 
                    return AbstractValueHolder(self.) 
                end
