...
_typelib_version::Tuple

                    PyCOMTest(intval::Any, longval::Any, ulongval::Any, _com_interfaces_::Vector{String} = ["IPyCOMTest"], _reg_clsid_::String = "{e743d9cd-cb03-4b04-b516-11d3a81c1597}", _reg_progid_::String = "Python.Test.PyCOMTest", _typelib_guid_::String = "{6BCDCB60-5605-11D0-AE5F-CADD4C000000}", _typelib_version::Tuple = (1, 0)) =
...
function TestInOut(self::PyCOMTest, fval, bval, lval)::Tuple
...
_typelib_version::Tuple
                    ...
                    PyCOMTestMI(_com_interfaces_::Vector{String} = ["IPyCOMTest", IID_IStream(pythoncom), string(IID_IStorage(pythoncom))], _reg_clsid_::String = "{F506E9A1-FB46-4238-A597-FA4EB69787CA}", _reg_progid_::String = "Python.Test.PyCOMTestMI", _typelib_guid_::String = "{6BCDCB60-5605-11D0-AE5F-CADD4C000000}", _typelib_version::Tuple = (1, 0)) =
                        new(_com_interfaces_, _reg_clsid_, _reg_progid_, _typelib_guid_, _typelib_version)
end

function main()
UseCommandLine(win32com.server.register, PyCOMTest)
UseCommandLine(win32com.server.register, PyCOMTestMI)
end
