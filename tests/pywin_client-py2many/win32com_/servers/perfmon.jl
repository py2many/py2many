...
using win32com.server: exception, register
import win32pdhutil
import winerror
...
_reg_verprogid_::String
                    ...
                    PerfMonQuery(_public_methods_::Vector{String} = ["Query"], _reg_class_spec_::String = "win32com.servers.perfmon.PerfMonQuery", _reg_clsid_::String = "{64cef7a0-8ece-11d1-a65a-00aa00125a98}", _reg_desc_::String = "Python Performance Monitor query object", _reg_progid_::String = "Python.PerfmonQuery", _reg_verprogid_::String = "Python.PerfmonQuery.1") =
