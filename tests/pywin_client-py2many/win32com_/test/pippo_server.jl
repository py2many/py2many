...
_typelib_version_::Tuple
                    ...
                    CPippo(MyProp1::Int64 = 10, _com_interfaces_::Vector{String} = ["IPippo"], _reg_clsid_::String = "{1F0F75D6-BD63-41B9-9F88-2D9D2E1AA5C3}", _reg_desc_::String = "Pippo Python test object", _reg_progid_::String = "Python.Test.Pippo", _typelib_guid_::String = "{7783054E-9A20-4584-8C62-6ED2A08F6AC6}", _typelib_version_::Tuple = (1, 0)) =
...
k = CPippo
try
UnRegisterTypeLib(pythoncom, _typelib_guid_(k), _typelib_version_(k)[1], _typelib_version_(k)[2], 0, SYS_WIN32(pythoncom))
