...
_public_methods_::Vector{String}
                    ...
                    TestServer(_com_interfaces_::Vector = [IID_IStream(pythoncom)], _public_methods_::Vector{String} = ["Clone", "Commit", "LockRegion", "Read"]) =
...
function testLogger()
@assert(!hasattr(win32com, "logger"))
