...
hresult::Any
            ...
            COMException(description = nothing, scode = nothing, source = nothing, helpfile = nothing, helpContext = nothing, desc = nothing, hresult = nothing, helpcontext = helpContext) = begin
                if scode && scode != 1
