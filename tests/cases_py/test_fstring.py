...
"""
    ...
    def test_double_braces(self):
        ...
        self.assertAllRaise(
            TypeError, "unhashable type", ["f'{ {{}} }'"]  # dict in a set
        )
    ...
    def test_format_specifier_expressions(self):
        ...
        self.assertAllRaise(
            ...
            ["f'{4:{/5}}'"],  # Invalid syntax inside a nested spec.
        )
    ...
    def test_parens_in_expressions(self):
        ...
        self.assertAllRaise(
            SyntaxError,
            "f-string: invalid syntax",
            ["f'{,}'", "f'{,}'"],  # this is (,), which is an error
        )

        self.assertAllRaise(SyntaxError, r"f-string: unmatched '\)'", ["f'{3)+(4}'"])
...
4}""",
    ...
    def test_assignment(self):
        self.assertAllRaise(
            SyntaxError, r"invalid syntax", ["f'' = 3", "f'{0}' = x", "f'{x}' = x"]
        )
    ...
    def test_errors(self):
        # see issue 26287
        self.assertAllRaise(
            TypeError, "unsupported", [r"f'{(lambda: 0):x}'", r"f'{(0,):x}'"]
        )
        self.assertAllRaise(
            ValueError, "Unknown format code", [r"f'{1000:j}'", r"f'{1000:j}'"]
        )
