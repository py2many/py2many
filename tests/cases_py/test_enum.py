...
class TestEnum(unittest.TestCase):
    ...
    @unittest.skipIf(
        python_version >= (3, 12), "__contains__ now returns True/False for all inputs"
    )
    ...
    @unittest.skipUnless(
        python_version == (3, 9), "private variables are now normal attributes"
    )
...
class TestIntEnumConvert(unittest.TestCase):
    ...
    @unittest.skipUnless(python_version == (3, 8), "_convert was deprecated in 3.8")
    ...
    @unittest.skipUnless(python_version >= (3, 9), "_convert was removed in 3.9")
