...
class CScintillaView(docview.CtrlView, control.CScintillaColorEditInterface):
    ...
    def DoConfigChange(self):
        ...
        from win32com_.gen_py.framework.editor import GetEditorOption
    ...
    def OnCmdFileLocate(self, cmd, id):
        ...
        if m:
            ...
            fileName = win32com_.gen_py.framework.scriptutils.LocatePythonFile(modName)
            if fileName is None:
    ...
    def _GetClassInfoFromBrowser(self, pos=-1):
        ...
        curmodule, path = win32com_.gen_py.framework.scriptutils.GetPackageModuleName(path)
        try:
    ...
    def _GetObjectAtPos(self, pos=-1, bAllowCalls=0):
        ...
        if left:  # It is an attribute lookup
            ...
            try:
                from win32com_.gen_py.framework import interact
