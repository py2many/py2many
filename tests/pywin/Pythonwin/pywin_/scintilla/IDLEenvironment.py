...
from win32com_.gen_py.mfc.dialog import GetSimpleInput
...
def GetIDLEModule(module):
    try:
        ...
        modname = "win32com_.gen_py.idle." + module
        __import__(modname)
...
def test():
    ...
    d = win32com_.gen_py.framework.editor.editorTemplate.OpenDocumentFile(None)
    e = d.GetFirstView()
    t = TkText(e)
