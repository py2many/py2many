...
import win32com_.gen_py.debugger, sys, time
import traceback
...
def a():
    ...
    try:
        ...
        win32com_.gen_py.debugger.post_mortem(sys.exc_info()[2])
        a = 1
        a = 2
        a = 3
        a = 4
...
def b():
    b = 1
    win32com_.gen_py.debugger.set_trace()
    ...
    # "win32com_.gen_py.debugger.brk()" is a shorter alias for this.
    c()
    pass
