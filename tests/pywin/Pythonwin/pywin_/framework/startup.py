...
# we update the win32com_.gen_py path to ensure it is absolute.
...
import win32com_.gen_py, win32com_.gen_py.framework

win32com_.gen_py.__path__[0] = win32ui.FullPath(win32com_.gen_py.__path__[0])
win32com_.gen_py.framework.__path__[0] = win32ui.FullPath(win32com_.gen_py.framework.__path__[0])
