...
##	# If someone has set win32com_.gen_py.editormodulename, then this is what we use
##	try:
##		prefModule = win32com_.gen_py.editormodulename
...
##		if mod is None:
##			prefModule = "win32com_.gen_py.framework.editor.color.coloreditor"
##			mod = __import__(prefModule)
##
...
from win32com_.gen_py.framework.editor.color.coloreditor import editorTemplate
