...
class EditorPropertyPage(dialog.PropertyPage):
    def __init__(self):
        ...
        self["Configs"] = win32com_.gen_py.scintilla.config.find_config_files()
    ...
    def OnInitDialog(self):
        ...
        # Source Safe
        bVSS = (
            GetEditorOption("Source Control Module", "") == "win32com_.gen_py.framework.editor.vss"
        )
        self["bVSS"] = bVSS
    ...
    def OnOK(self):
        ...
        if configname:
            ...
            win32com_.gen_py.scintilla.view.LoadConfiguration()
