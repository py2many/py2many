...
from win32com_.gen_py.mfc import docview, object
...
class EditorDocumentBase(ParentEditorDocument):
    ...
    def _DocumentStateChanged(self):
        ...
        if win32com_.gen_py.debugger.currentDebugger is not None:
            win32com_.gen_py.debugger.currentDebugger.UpdateDocumentLineStates(self)
...
class FileWatchingThread(win32com_.gen_py.mfc.thread.WinThread):
