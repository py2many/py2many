...
from win32com_.gen_py.scintilla import bindings

from win32com_.gen_py.framework.editor import (
    GetEditorOption,
    SetEditorOption,
    GetEditorFontOption,
    SetEditorFontOption,
...
# from win32com_.gen_py.framework.editor import EditorPropertyPage
...
from win32com_.gen_py.debugger import dbgcon
from win32com_.gen_py.scintilla.document import CScintillaDocument
from win32com_.gen_py.framework.editor.document import EditorDocumentBase
from win32com_.gen_py.scintilla import scintillacon  # For the marker definitions
...
class SyntEditView(SyntEditViewParent):
    ...
    def OnInitialUpdate(self):
        ...
        try:
            ...
            if win32com_.gen_py.debugger.currentDebugger is None:
    ...
    def ShowInteractiveWindowEvent(self, event):
        ...
        win32com_.gen_py.framework.interact.ShowInteractiveWindow()
...
from win32com_.gen_py.framework.editor.frame import EditorFrame
...
from win32com_.gen_py.framework.editor.template import EditorTemplateBase
...
class SyntEditTemplate(EditorTemplateBase):
    ...
    def CheckIDLEMenus(self, idle):
        ...
        for text, event in newitems:
            ...
            if id is not None:
                keyname = win32com_.gen_py.scintilla.view.configManager.get_key_binding(
                    event, ["editor"]
                )
    ...
    def GetPythonPropertyPages(self):
        ...
        from win32com_.gen_py.scintilla import configui
