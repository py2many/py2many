...
import commctrl
import win32api
from win32com_.gen_py.tools import hierlist, browser
...
class BrowserView(win32com_.gen_py.mfc.docview.TreeView):
    ...
    def _MakeRoot(self):
        ...
        if not path:
            ...
            mod, path = win32com_.gen_py.framework.scriptutils.GetPackageModuleName(path)
            if self.bDirty:
                what = "Refreshing"
