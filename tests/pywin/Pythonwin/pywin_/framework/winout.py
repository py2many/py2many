...
from win32com_.gen_py.framework import app, window
...
from win32com_.gen_py.scintilla import scintillacon
from win32com_.gen_py import default_scintilla_encoding
...
class WindowOutputViewScintilla(
    win32com_.gen_py.scintilla.view.CScintillaView, WindowOutputViewImpl
):
    def __init__(self, doc):
    ...
    def OnInitialUpdate(self):
        win32com_.gen_py.scintilla.view.CScintillaView.OnInitialUpdate(self)
        self.SCISetMarginWidth(3)
        WindowOutputViewImpl.OnInitialUpdate(self)

    def OnDestroy(self, msg):
        WindowOutputViewImpl.OnDestroy(self, msg)
        win32com_.gen_py.scintilla.view.CScintillaView.OnDestroy(self, msg)

    def HookHandlers(self):
        WindowOutputViewImpl.HookHandlers(self)
        win32com_.gen_py.scintilla.view.CScintillaView.HookHandlers(self)
