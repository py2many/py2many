...
import warnings
from win32com_.gen_py.scintilla.control import CScintillaEditInterface
...
class DebuggerCommandHandler:
    ...
    def OnAdd(self, msg, code):
        ...
        if d is None:
            ...
            doc.MarkerToggle(
                lineNo, win32com_.gen_py.framework.editor.color.coloreditor.MARKER_BREAKPOINT
            )
        else:
    ...
    def OnClearAll(self, msg, code):
        ...
        if d is None:
            ...
            for doc in win32com_.gen_py.framework.editor.editorTemplate.GetDocumentList():
                doc.MarkerDeleteAll(
