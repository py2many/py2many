...
import string
import os
from win32com_.gen_py.mfc import window, dialog, afxres
from win32com_.gen_py.mfc.thread import WinApp
import traceback
import regutil
...
def HaveGoodGUI():
    ...
    return "win32com_.gen_py.framework.startup" in sys.modules
