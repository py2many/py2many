            ...
            if look and look < start - 1:  # Did we find a char before the \n\r sets?
                ...
                if strstyle is not None:
                    if strstyle.name == win32com_.gen_py.scintilla.formatter.STYLE_TQSSTRING:
                        quote_char = "'"
                    elif strstyle.name == win32com_.gen_py.scintilla.formatter.STYLE_TQDSTRING:
                        quote_char = '"'
...
class InteractiveCore:
    ...
    def HookHandlers(self):
        ...
        mod = win32com_.gen_py.scintilla.IDLEenvironment.GetIDLEModule("IdleHistory")
        if mod is not None:
...
class InteractiveView(InteractiveCore, winout.WindowOutputView):
    def __init__(self, doc):
        ...
        self.encoding = win32com_.gen_py.default_scintilla_encoding
...
class DockedInteractiveView(DockedInteractiveViewParent):
    ...
    def OnDestroy(self, msg):
        ...
        win32com_.gen_py.framework.app.SaveWindowSize("Interactive Window", newSize, "docked")
        try:
...
class CDockedInteractivePython(CInteractivePython):
    ...
    def Create(self):
        ...
        defRect = win32com_.gen_py.framework.app.LoadWindowSize("Interactive Window", "docked")
...
def CreateDockedInteractiveWindow():
    ...
    # children.
    from win32com_.gen_py.docking.DockingBar import DockingBar
