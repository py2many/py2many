...
from win32com_.client import constants, DispatchBaseClass, CastTo, VARIANT
...
def TestGenerated():
    ...
    # This is `CoPyComTest`
    from win32com_.client.CLSIDToClass import GetClass
    ...
    o2 = win32com_.client.DispatchWithEvents(o, RandomEventHandler)
    TestEvents(o2, o2)
    o2 = win32com_.client.DispatchWithEvents(o, NewStyleRandomEventHandler)
    TestEvents(o2, o2)
    # and a plain "WithEvents".
    handler = win32com_.client.WithEvents(o, RandomEventHandler)
    TestEvents(o, handler)
    handler = win32com_.client.WithEvents(o, NewStyleRandomEventHandler)
    TestEvents(o, handler)
...
def TestVTable(clsctx=pythoncom.CLSCTX_ALL):
    ...
    ob = win32com_.client.Dispatch("Python.Test.PyCOMTest")
    TestLocalVTable(ob)
    # Now test it via vtable - use some C++ code to help here as Python can't do it directly yet.
    tester = win32com_.client.Dispatch("PyCOMTest.PyCOMTest")
