...
function OnInitDialog(self::EditorPropertyPage)
    ...
    bVSS =
        ...
        "win32com_.gen_py.framework.editor.vss"
    self["bVSS"] = bVSS
    ...
    try
        SelectString(
            GetDlgItem(self, win32ui.IDC_KEYBOARD_CONFIG),
            -1,
    ...
    self.initialEdgeColor =
        GetEditorOption("Right Edge Color", RGB(win32api, 239, 239, 239))
...
function OnOK(self::EditorPropertyPage)::Int64
    ...
    elseif GetEditorOption("Source Control Module", "") ==
           "win32com_.gen_py.framework.editor.vss"
...
function _AddEditorOption(
    self::EditorWhitespacePropertyPage,
    idd,
    typ,
    optionName,
    defaultVal,
