        ...
        try
            ...
            if doc != nothing
                ...
                while true
                    ...
                    posFind, foundSel = FindText(
                        view,
                        flags,
                        (0, GetTextLength(view)),
...
function _GetDialogTemplate(self::FindDialog)
    ...
    dt = [
        ["Find", (0, 2, 240, 75), style, nothing, (8, "MS Sans Serif")],
        ...
        [
            ...
            (
                (
                    ((visible | win32con.WS_BORDER) | win32con.WS_TABSTOP) |
                    win32con.WS_VSCROLL
