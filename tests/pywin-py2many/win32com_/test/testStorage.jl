...
pss = StgOpenStorageEx(pythoncom, fname, m, storagecon.STGFMT_FILE, 0, pythoncom.IID_IPropertySetStorage)
...
pssum = nothing
pss = nothing
pssread = StgOpenStorageEx(pythoncom, fname, storagecon.STGM_READ | storagecon.STGM_SHARE_EXCLUSIVE, storagecon.STGFMT_FILE, 0, pythoncom.IID_IPropertySetStorage)
found_summaries = []
