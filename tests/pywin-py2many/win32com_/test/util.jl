...
old_log = hasfield(win32com_, "logger"): getfield(win32com_, "logger" ? nothing
...
if hasfield(self, "do_leak_tests"): getfield(self, "do_leak_tests" ? 0 && hasattr(sys, "gettotalrefcount")
