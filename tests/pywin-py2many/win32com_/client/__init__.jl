...
dispatch = CoCreateInstanceEx(pythoncom, clsid, nothing, clsctx, serverInfo, (pythoncom.IID_IDispatch,))[1]
...
mod = nothing
if typelib != nothing
mod = MakeModuleForTypelib(gencache, typelib.clsid, typelib.lcid, parse(Int, typelib.major), parse(Int, typelib.minor))
...
mod = GetModuleForTypelib(gencache, mod.CLSID, mod.LCID, mod.MajorVersion, mod.MinorVersion)
...
target_class = hasfield(target_class, "default_interface"): getfield(target_class, "default_interface" ? target_class
...
package = GetModuleForTypelib(gencache, module_.CLSID, module_.LCID, module_.MajorVersion, module_.MinorVersion)
try
...
return GetRecordFromGuids(pythoncom, module_.CLSID, module_.MajorVersion, module_.MinorVersion, module_.LCID, struct_guid)
end
...
other = hasfield(other, "_oleobj_"): getfield(other, "_oleobj_" ? other
