...
_frozen = hasfield(sys, "frozen"): getfield(sys, "frozen" ? 1 == 0
if _frozen && !hasfield(pythoncom, "frozen"): getfield(pythoncom, "frozen" ? 0
...
if !(found) != 0
try
append(__path__, GetFullPathName(win32api, __path__[1] + "\\..\\win32comext"))
catch exn
if exn isa win32api.error
#= pass =#
end
