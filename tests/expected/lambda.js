...
(function dartProgram() {
  ...
  U = {
    show: function() {
      H.printString(H.S(J.toString$0$($.$get$sprintf().call$2("%s", [new U.show_closure().call$2(1, 2)]))));
    },
    main: function(argv) {
      U.show();
    },
    show_closure: function show_closure() {
    }
  };
