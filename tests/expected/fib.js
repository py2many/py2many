...
(function dartProgram() {
  ...
  T = {
    fib: function(i) {
      if (i === 0 || i === 1)
        return 1;
      return T.fib(i - 1) + T.fib(i - 2);
    },
    main: function(argv) {
      H.printString(H.S(J.toString$0$($.$get$sprintf().call$2("%s", H.setRuntimeTypeInfo([T.fib(5)], type$.JSArray_legacy_int)))));
    }
  };
  var holders = [C, H, J, P, O, T];
  ...
  (function(callback) {
    ...
    var callMain = function(args) {
      return T.main(H.convertMainArgumentList(args));
    };
