...
(function dartProgram() {
  ...
  Z = {
    ...
    show: function() {
      var t1, t2, i, t3, _i, sum1, a6, a7, _s2_ = "%s";
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([2.1], type$.JSArray_legacy_double)));
      t1 = type$.JSArray_legacy_int;
      ...
      for (; _i < t2.length; t2.length === t3 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
        i = t2[_i];
        H.printString(H.S(J.toString$0$($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([i], t1)))));
      }
      t2 = H.setRuntimeTypeInfo([], t1);
      for (i = 0; i < 10; i += 2)
        t2.push(i);
      ...
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([0], t1)));
      sum1 = Z.indexing();
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([sum1], t1)));
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([3], t1)));
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([4], t1)));
      t2 = type$.legacy_int;
      a6 = P.LinkedHashSet_LinkedHashSet$from([1, 2, 3, 4], t2);
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([a6._length], t1)));
      a7 = P.LinkedHashMap_LinkedHashMap$_literal(["a", 1, "b", 2], type$.legacy_String, t2);
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([a7.__js_helper$_length], t1)));
      t1 = type$.JSArray_legacy_String;
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo(["true"], t1)));
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo(["true"], t1)));
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo(["World is sane"], t1)));
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo(["True"], t1)));
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo(["true"], t1)));
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo(["1    2"], t1)));
    },
    main: function(argv) {
      Z.show();
    }
  };
  var holders = [C, H, J, P, O, Z];
  ...
  P._SetBase.prototype = {$isIterable: 1};
  ...
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"JSBool":{"bool":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[]},"JSNumNotInt":{"double":[],"num":[]},"JSString":{"String":[],"Pattern":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2"},"JsLinkedHashMap":{"MapMixin":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"]},"JSSyntaxRegExp":{"Pattern":[]},"_MatchImplementation":{"RegExpMatch":[]},"_LinkedHashSet":{"SetMixin":["1"],"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"_SetBase":{"SetMixin":["1"],"Iterable":["1"]},"double":{"num":[]},"int":{"num":[]},"String":{"Pattern":[]},"FloatFormatter":{"Formatter":[]},"IntFormatter":{"Formatter":[]},"StringFormatter":{"Formatter":[]}}'));
  H._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"MapBase":2,"_SetBase":1,"__SetBase_Object_SetMixin":1}'));
  0;
