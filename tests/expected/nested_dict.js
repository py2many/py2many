...
(function dartProgram() {
  ...
  Y = {
    main: function(argv) {
      var t1 = P.LinkedHashMap_LinkedHashMap$_literal(["KEY", H.setRuntimeTypeInfo([1, 3], type$.JSArray_legacy_int)], type$.legacy_String, type$.legacy_List_legacy_int).$index(0, "KEY");
      if ((t1 && C.JSArray_methods).contains$1(t1, 1))
        H.printString(H.S(J.toString$0$($.$get$sprintf().call$2("%s", H.setRuntimeTypeInfo(["OK"], type$.JSArray_legacy_String)))));
    }
  };
  var holders = [C, H, J, P, O, Y];
  ...
  (function(callback) {
    ...
    var callMain = function(args) {
      return Y.main(H.convertMainArgumentList(args));
    };
...
//# sourceMappingURL=nested_dict.js.map
