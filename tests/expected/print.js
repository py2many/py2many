...
(function dartProgram() {
  ...
  D = {
    main: function(argv) {
      ...
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo(["b"], t1)));
      P.print($.$get$sprintf().call$2("%s %s", H.setRuntimeTypeInfo([2, "b"], type$.JSArray_legacy_Object)));
      t2 = type$.JSArray_legacy_double;
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([2.1], t2)));
      P.print($.$get$sprintf().call$2(_s2_, H.setRuntimeTypeInfo([2.1], t2)));
      t2 = $.$get$sprintf();
      P.print(t2.call$2(_s2_, H.setRuntimeTypeInfo(["True"], t1)));
    }
  };
  var holders = [C, H, J, P, O, D];
  ...
  (function(callback) {
    ...
    var callMain = function(args) {
      return D.main(H.convertMainArgumentList(args));
    };
