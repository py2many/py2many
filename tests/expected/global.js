...
(function dartProgram() {
  ...
  M = {
    main: function(argv) {
      var t1, _i, i;
      for (t1 = type$.JSArray_legacy_int, _i = 0; _i < 2; ++_i) {
        i = $.l_a[_i];
        H.printString(H.S(J.toString$0$($.$get$sprintf().call$2("%s", H.setRuntimeTypeInfo([i], t1)))));
      }
      for (t1 = type$.JSArray_legacy_String, _i = 0; _i < 2; ++_i) {
        i = $.l_b[_i];
        H.printString(H.S(J.toString$0$($.$get$sprintf().call$2("%s", H.setRuntimeTypeInfo([i], t1)))));
      }
      if (C.JSArray_methods.contains$1(H.setRuntimeTypeInfo(["a", "b"], t1), "a"))
        P.print($.$get$sprintf().call$2("%s", H.setRuntimeTypeInfo(["OK"], t1)));
    }
  };
  var holders = [C, H, J, P, O, M];
  ...
  (function staticFields() {
    ...
    $.l_a = H.setRuntimeTypeInfo([0, 1], type$.JSArray_legacy_int);
    $.l_b = H.setRuntimeTypeInfo(["a", "b"], type$.JSArray_legacy_String);
  })();
  ...
  (function(callback) {
    ...
    var callMain = function(args) {
      return M.main(H.convertMainArgumentList(args));
    };
