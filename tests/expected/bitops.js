...
(function dartProgram() {
  ...
  E = {
    main_func: function() {
      var _i, a, t2, _i0, b,
        t1 = type$.JSArray_legacy_bool,
        ands = H.setRuntimeTypeInfo([], t1),
        ors = H.setRuntimeTypeInfo([], t1),
        xors = H.setRuntimeTypeInfo([], t1);
      for (t1 = [false, true], _i = 0; _i < 2; ++_i) {
        a = t1[_i];
        for (t2 = [false, true], _i0 = 0; _i0 < 2; ++_i0) {
          b = t2[_i0];
          C.JSArray_methods.add$1(ands, C.JSBool_methods.$and(a, b));
          C.JSArray_methods.add$1(ors, C.JSBool_methods.$or(a, b));
          C.JSArray_methods.add$1(xors, C.JSBool_methods.$xor(a, b));
        }
      }
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Error, P.Iterable, H.ListIterator, H.Closure, P.MapMixin, H.LinkedHashMapCell, H.LinkedHashMapKeyIterator, H.JSSyntaxRegExp, H._MatchImplementation, H._AllMatchesIterator, H.Rti, H._FunctionParameters, P.OutOfMemoryError, P._Exception, P.FormatException, P.Null, P.StringBuffer, O.Formatter, O.PrintFormat]);
